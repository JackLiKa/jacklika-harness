...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/fs/memory-git': { kind: 'none', reason: 'The tools/execute wrapper only adds a durable git-commit side effect; it registers no prompt, schema, or result of its own.' },
  ...
  'packages/bundle/memory': { kind: 'indirect', reason: 'The bundle is a patch-list carrier; each inserted row\'s package owns its model-facing behavior.' },
