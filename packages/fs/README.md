...
| [`memory-git/`](memory-git/README.md) | Commits successful memory-tool writes (default `wiki_write`) to git through the `tools/execute` waterfall | `tools/execute` listener |
